...
public class Handler implements Runnable {
    ...
    public Handler(AtomicReference<Session> session,AtomicReference<String> message, AtomicReference<JsonObject> googleAccessToken,AtomicReference<Database> database, AtomicBoolean hasEmails){
    ...
    public Handler(Handler handler, String message, Thread oldThread){
