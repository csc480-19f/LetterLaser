...
public class DebugLogger {
    ...
    private static String localFilePath = "";//fill this for your local path if you want to debug on pc and replace piFilePath in filehandler constructor

    private DebugLogger(){
        logger.setUseParentHandlers(false);
        try {
            //first var is the path to log file and second is to append or not (true is to append, replaces old file);
            fh = new FileHandler(piFilePath,true);
