...
class EmailAddrTest {
	...
	void testGetReceivedEmail() {
		db.query("INSERT INTO email (subject) VALUES " + "('sub1');");
		db.query("INSERT INTO email_addr (email_address) VALUES " + "('test@mail')," + "('test2@mail'),"
				+ "('test3@mail');");
		db.query("INSERT INTO received_email (email_id, email_addr_id) VALUES " + "(1, 1)," + "(1, 2)," + "(1, 3);");
	...
	@Test
	void testReceivedEmailNotExists() {
		db.query("INSERT INTO email (subject) VALUES " + "('sub1');");
		db.query("INSERT INTO email_addr (email_address) VALUES " + "('test@mail')," + "('test2@mail'),"
				+ "('test3@mail');");
		db.query("INSERT INTO received_email (email_id, email_addr_id) VALUES " + "(1, 1)," + "(1, 2)," + "(1, 3);");
